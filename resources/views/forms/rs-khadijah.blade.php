...
@section('title', 'Form RS Khadijah')
...
<div class="main-container">
    <div class="form-container">
        ...
        <form action="{{ route('data.store') }}" method="POST" id="data-form">
            @csrf
            <input type="hidden" name="nama_instansi" value="RS Khadijah">
            ...
            <div class="form-group">
                ...
                <input type="number" step="1" id="rawat_jalan" name="rskhadijah_rawat_jalan" required placeholder="Jumlah pasien">
            </div>
            <div class="form-group">
                <label for="rawat_inap">Jumlah Pasien Rawat Inap:</label>
                <input type="number" step="1" id="rawat_inap" name="rskhadijah_rawat_inap" required placeholder="Jumlah pasien">
            </div>
        ...
        <div class="info-box">
            ...
            <ul>
                <li>Masukkan jumlah total pasien (bukan kunjungan) untuk Rawat Jalan dan Rawat Inap.</li>
                <li>Isi dengan angka <strong>0</strong> jika tidak ada pasien pada bulan tersebut.</li>
            </ul>
        </div>
    </div>
    ...
    <div class="preview-container">
        ...
        <div class="table-wrapper">
            <div id="preview-table-container" data-url="{{ route('preview.data', Str::slug('RS Khadijah')) }}">
                @include('partials.preview-table-rs-khadijah', ['sheetData' => $sheetData, 'previewError' => $previewError])
            </div>
        </div>
    </div>
</div>
