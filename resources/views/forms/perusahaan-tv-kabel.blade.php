...
@section('title', 'Form Perusahaan TV Kabel')
...
<div class="main-container">
    <div class="form-container">
        ...
        <form action="{{ route('data.store') }}" method="POST" id="data-form">
            @csrf
            <input type="hidden" name="nama_instansi" value="Perusahaan TV Kabel">
            ...
            <div class="form-group">
                <label for="pendapatan">Pendapatan Usaha (Rp):</label>
                <input type="number" id="pendapatan" name="tvkabel_pendapatan" placeholder="Contoh: 7625000" required>
            </div>

            <div class="form-group">
                <label for="jumlah_pelanggan">Jumlah Pelanggan:</label>
                <input type="number" id="jumlah_pelanggan" name="tvkabel_jumlah_pelanggan" placeholder="Contoh: 125" required>
            </div>
    ...
    <div class="preview-container">
        ...
        <div class="table-wrapper">
            <div id="preview-table-container" data-url="{{ route('preview.data', $slugInstansi) }}">
                @include('partials.preview-table-tv-kabel', ['sheetData' => $sheetData, 'previewError' => $previewError])
            </div>
        </div>
    </div>
</div>
