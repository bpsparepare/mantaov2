...
@section('title', 'Form Universitas Muhammadiyah Parepare')
...
<div class="main-container">
    <div class="form-container">
        ...
        <form action="{{ route('data.store') }}" method="POST" id="data-form">
            @csrf
            <input type="hidden" name="nama_instansi" value="Universitas Muhammadiyah Parepare">
    ...
    <div class="preview-container">
        ...
        <div class="table-wrapper">
            <div id="preview-table-container" data-url="{{ route('preview.data', Str::slug('Universitas Muhammadiyah Parepare')) }}">
