...
<div class="main-container">
    <div class="form-container">
        ...
        <form action="{{ route('data.store') }}" method="POST" id="data-form">
            @csrf
            <input type="hidden" name="nama_instansi" value="RS Fatima">
            ...
            <div class="form-group">
                ...
                <input type="number" id="rawat_inap" name="rsfatima_rawat_inap" placeholder="Contoh: 787" required>
            </div>

            <div class="form-group">
                <label for="rawat_jalan">Jumlah Pasien Rawat Jalan:</label>
                <input type="number" id="rawat_jalan" name="rsfatima_rawat_jalan" placeholder="Contoh: 2712" required>
            </div>
    ...
    <div class="preview-container">
        ...
        <div class="table-wrapper">
            <div id="preview-table-container" data-url="{{ route('preview.data', $slugInstansi) }}">
                @include('partials.preview-table-rs-fatima', ['sheetData' => $sheetData, 'previewError' => $previewError])
            </div>
        </div>
    </div>
</div>
