    ...
    <div class="form-container">
        ...
        <form action="{{ route('data.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" id="surat_dikirim" name="pos_surat_dikirim" placeholder="Contoh: 8161" required>
            </div>
            <div class="form-group">
                <label for="surat_diterima">Jumlah Surat Diterima:</label>
                <input type="number" id="surat_diterima" name="pos_surat_diterima" placeholder="Contoh: 4710" required>
            </div>
            <div class="form-group">
                <label for="wesel_pos">Jumlah Wesel Pos (Rp):</label>
                <input type="number" id="wesel_pos" name="pos_wesel_pos" placeholder="Contoh: 2039000" required>
            </div>
