...
@section('title', 'Form Universitas Negeri Makassar - Parepare')
...
<div class="main-container">
    <div class="form-container">
        <div class="form-header">
            ...
            <p>Universitas Negeri Makassar - Parepare</p>
        </div>
        ...
        <form action="{{ route('data.store') }}" method="POST">
            @csrf
            <input type="hidden" name="nama_instansi" value="Universitas Negeri Makassar - Parepare">
            ...
            <div class="form-group">
                ...
                <input type="number" step="1" id="jumlah_mahasiswa" name="jumlah_mahasiswa" required placeholder="Jumlah mahasiswa">
            </div>
        ...
        <div class="info-box">
            ...
            <ul>
                <li>Masukkan jumlah total mahasiswa yang terdata pada bulan pelaporan.</li>
    ...
    <div class="preview-container">
        ...
        <div class="table-wrapper">
            <div id="preview-table-container" data-url="{{ route('preview.data', Str::slug('Universitas Negeri Makassar - Parepare')) }}">
                @include('partials.preview-table-ump', ['sheetData' => $sheetData, 'previewError' => $previewError])
            </div>
        </div>
    </div>
</div>
