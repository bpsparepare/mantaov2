...
@section('title', 'Form Perusahaan Es Balok')
...
<style>
    ...
    /* --- (OPSIONAL) PENYESUAIAN TEMA AGAR KONSISTEN --- */
    .submit-btn {
        width: 100%;
        padding: 15px;
        border: none;
...
<div class="main-container">
    <div class="form-container">
        ...
        <form action="{{ route('data.store') }}" method="POST">
            @csrf
            <input type="hidden" name="nama_instansi" value="Perusahaan Es Balok">
            ...
            <div class="form-group">
                <label for="produksi_es">Produksi Es Batu (Ton):</label>
                <input type="number" step="any" id="produksi_es" name="esbalok_produksi_ton" required>
            </div>
        ...
        <div class="info-box">
            ...
            <ul>
                ...
                <li>Jika pada bulan tertentu tidak ada produksi, harap isi dengan angka <strong>0</strong>.</li>
            </ul>
        </div>
    </div>
    ...
    <div class="preview-container">
        ...
        <div class="table-wrapper">
            <div id="preview-table-container" data-url="{{ route('preview.data', $slugInstansi) }}">
                @include('partials.preview-table-es-balok', ['sheetData' => $sheetData, 'previewError' => $previewError])
            </div>
        </div>
    </div>
</div>
