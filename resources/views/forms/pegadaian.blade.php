...
<div class="main-container">
    <div class="form-container">
        ...
        <form action="{{ route('data.store') }}" method="POST">
            @csrf
            <input type="hidden" name="nama_instansi" value="Pegadaian">
            ...
            <div class="form-group">
                ...
                <input type="number" step="1" id="jumlah_nasabah" name="pegadaian_jumlah_nasabah" required placeholder="Jumlah nasabah">
            </div>
            <div class="form-group">
                <label for="nilai_gadai">Nilai Barang Gadai (Rp):</label>
                <input type="number" step="any" id="nilai_gadai" name="pegadaian_nilai_gadai" required placeholder="Contoh: 31651280000">
            </div>
        ...
        <div class="info-box">
            ...
            <ul>
                <li>Masukkan jumlah nasabah tanpa pemisah ribuan.</li>
                <li>Masukkan total nilai gadai dalam Rupiah, tanpa titik, koma, atau simbol "Rp".</li>
            </ul>
        </div>
    </div>
    ...
    <div class="preview-container">
        ...
        <div class="table-wrapper">
            <div id="preview-table-container" data-url="{{ route('preview.data', Str::slug('Pegadaian')) }}">
                @include('partials.preview-table-pegadaian', ['sheetData' => $sheetData, 'previewError' => $previewError])
            </div>
        </div>
    </div>
</div>
