    ...
    <div class="form-container">
        ...
        <form action="{{ route('data.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" step="1" id="jumlah_pedagang" name="perdagangan_jumlah_pedagang" required placeholder="Jumlah pedagang">
            </div>
        ...
        <div class="info-box">
            ...
            <ul>
                <li>Masukkan jumlah total pedagang yang terdata pada bulan pelaporan.</li>
