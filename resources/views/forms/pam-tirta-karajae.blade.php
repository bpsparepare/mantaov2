...
@section('title', 'Form PAM Tirta Karajae')
...
<div class="main-container">
    <div class="form-container">
        ...
        <form action="{{ route('data.store') }}" method="POST">
            @csrf
            <input type="hidden" name="nama_instansi" value="PAM Tirta Karajae">
            ...
            <div class="form-group">
                <label for="volume_air">Volume Air yang disalurkan (m3):</label>
                <input type="number" id="volume_air" name="pdam_volume_air" placeholder="Contoh: 392720" required>
            </div>

            <div class="form-group">
                <label for="pendapatan_air">Pendapatan Penjualan Air Bersih (Rp):</label>
                <input type="number" id="pendapatan_air" name="pdam_pendapatan_air" placeholder="Contoh: 3157100601" required>
            </div>
        ...
        <div class="info-box">
            ...
            <ul>
                <li>Masukkan data tanpa pemisah ribuan (titik atau koma).</li>
    ...
    <div class="preview-container">
        ...
        <div class="table-wrapper">
            <div id="preview-table-container" data-url="{{ route('preview.data', $slugInstansi) }}">
                @include('partials.preview-table-pdam', ['sheetData' => $sheetData, 'previewError' => $previewError])
            </div>
        </div>
    </div>
</div>
