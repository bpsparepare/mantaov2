...
@section('title', 'Form Institut Ilmu Sosial dan Bisnis Andi Sapada')
...
<div class="main-container">
    <div class="form-container">
        <div class="form-header">
            ...
            <p>Institut Ilmu Sosial dan Bisnis Andi Sapada</p>
        </div>
        ...
        <form action="{{ route('data.store') }}" method="POST">
            @csrf
            <input type="hidden" name="nama_instansi" value="Institut Ilmu Sosial dan Bisnis Andi Sapada">
            ...
            <div class="form-group">
                ...
                <input type="number" id="jumlah_mahasiswa" name="andi_sapada_jumlah_mahasiswa" placeholder="Contoh: 1219" required>
            </div>

            <div class="form-group">
                <label for="pendapatan">Pendapatan (Rp):</label>
                <input type="number" id="pendapatan" name="andi_sapada_pendapatan" placeholder="Contoh: 82000000" required>
            </div>
        ...
        <div class="info-box">
            ...
            <ul>
                <li>Masukkan jumlah mahasiswa aktif pada bulan pelaporan.</li>
                <li>Masukkan total pendapatan dalam Rupiah, tanpa titik atau koma.</li>
                <li>Jika tidak ada data, biarkan kolom kosong.</li>
            </ul>
        </div>
    </div>
    ...
    <div class="preview-container">
        ...
        <div class="table-wrapper">
            <div id="preview-table-container" data-url="{{ route('preview.data', $slugInstansi) }}">
                @include('partials.preview-table-andi-sapada', ['sheetData' => $sheetData, 'previewError' => $previewError])
            </div>
        </div>
    </div>
</div>
