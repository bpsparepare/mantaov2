...
<div class="main-container">
    <div class="form-container">
        ...
        <form action="{{ route('data.store') }}" method="POST" id="data-form">
            @csrf
            <input type="hidden" name="nama_instansi" value="Dinas PUPR">
            ...
            <div class="form-group">
                ...
                <input type="number" step="1" id="jumlah_proyek" name="pupr_jumlah_proyek" required placeholder="Jumlah proyek">
            </div>
            <div class="form-group">
                <label for="jenis_konstruksi">Jenis Konstruksi:</label>
                <input type="text" id="jenis_konstruksi" name="pupr_jenis_konstruksi" required placeholder="Jenis konstruksi">
            </div>
            <div class="form-group">
                <label for="nilai_proyek">Nilai Proyek (Rp):</label>
                <input type="number" step="any" id="nilai_proyek" name="pupr_nilai_proyek" required placeholder="Nilai proyek">
            </div>
    ...
    <div class="preview-container">
        ...
        <div class="table-wrapper">
            <div id="preview-table-container" data-url="{{ route('preview.data', Str::slug('Dinas PUPR')) }}">
                @include('partials.preview-table-pupr', ['sheetData' => $sheetData, 'previewError' => $previewError])
            </div>
        </div>
    </div>
</div>
